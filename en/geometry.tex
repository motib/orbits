...
\begin{theorem}[Prop. XIII. Isogonal property of ellipses]\label{thm.marden-tangent} If two tangents are constructed to an ellipse from an external point, the angle between them and lines to the foci are equal (Figure~\ref{f.tangent-equal-angles}).
\end{theorem}
