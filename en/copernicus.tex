...
\coordinate (S) at (0,0) 
  node[above right,xshift=-2pt,yshift=-2pt] {$O,S$};
...
\node[above] at (SS) {\textsf{\small summer solstice}};
\coordinate (WS) at (-90:5cm);
\node[below] at (WS) {\textsf{\small winter solstice}};
\coordinate (SE) at (0:5cm);
%\node[right,xshift=5pt] at (SE) {\textsf{spring equinox}};
\node[above left,xshift=0pt] at (SE) {\textsf{\small SE}};
\coordinate (AE) at (180:5cm);
%\node[left,xshift=-5pt] at (AE) {\textsf{autumn equinox}};
\node[above right,xshift=0pt] at (AE) {\textsf{\small AE}};
...
\node at (45:1.8) {\textsf{\small spring}};
\node at (135:1.8) {\textsf{\small summer}};
\node at (-135:1.8) {\textsf{\small autumn}};
\node at (-45:1.8) {\textsf{\small winter}};

\end{tikzpicture}
\caption{The orbit of the Earth\\and the seasons\\
\textsf{\small AE=autumn equinox}, \textsf{\small SE=spring equinox}}\label{f.circle}
\end{center}
\end{minipage}
%%%%%%%%%%%%%%
\begin{minipage}{.48\textwidth}
...
\draw[name path=Csphere] (S) circle[radius=5cm];
\coordinate (O) at (-.5,.8);
\node[below left,yshift=0pt] at (O) {$O$};
...
% Names of the seasons
\node at (45:1.8) {\textsf{\small spring}};
\node[yshift=-2pt] at (140:2.1) {\textsf{\small summer}};
\node at (-135:2) {\textsf{\small autumn}};
\node at (-45:1.8) {\textsf{\small winter}};
...
\begin{eqn}
a &=& r \sin \alpha \approx r \alpha = r\widehat{AA'} = 0.0298r\\
b &=& r \sin \beta \approx  r\beta = r\widehat{BB'} = 0.0034r\,.
\end{eqn}%
...
\vertexsm{O};
\draw[name path=Eorbit] (O) circle[radius=3.25cm];
