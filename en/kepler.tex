...
\foreach \angle/\name/\c in { 110/E1/red, 70/E2/blue, 25/E3/{orange}, -40/E4/green} {
  \coordinate (\name) at (\angle:2.5);
  \draw[\c,thick] (O) -- (\name) -- (M);
}
...
\begin{eqn}
\frac{OE_i}{\sin \beta} &=& \frac{OM}{\sin \gamma}\\
...
\]
\vspace*{4ex}
\caption{Angles between the Earth\\and Mars, and distance $OE_i$}\label{f.oe}
\end{minipage}
\begin{minipage}{.48\textwidth}
\begin{center}
...
\begin{eqn}
%\frac{t}{365.25} &=& \frac{\theta_E}{360}\\
\theta_E &=& \frac{360}{365.25}t\\
