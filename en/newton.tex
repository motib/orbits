...
\begin{center}
\begin{tikzpicture}
\clip[draw] (-3.5,-2.2) rectangle +(7,5);
...
\clip[draw] (2,-.4) rectangle +(3.3,4.5);
% Padding to align captions
\path (3,3.6) rectangle +(2,.5);

\clip[draw] (2,-.4) rectangle +(3.5,4);
...
\clip[draw] (2,-.4) rectangle +(3.5,4.5);
...
\clip[draw] (-4.6,-.6) rectangle +(9.5,4.3);
