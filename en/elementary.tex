...
\begin{tikzpicture}[scale=.8]
  \clip[draw] (-1,-1.8) rectangle +(7,6.5);
...
\begin{center}
\begin{tikzpicture}[scale=.8]
  \clip[draw] (-4.6,-1.8) rectangle +(9.2,6.5);
\def\a{4.33}
\def\b{3}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%\section{The median of the hypotenuse}
%
...
\begin{center}
\begin{tikzpicture}[scale=.8]
\clip[draw] (-1,-2.5) rectangle +(8.7,5.5);
...
\begin{center}
\begin{tikzpicture}[scale=.8]
\clip[draw] (-.6,-2.5) rectangle +(9.2,6);
...
\begin{center}
\begin{tikzpicture}[scale=1.2]
\clip[draw] (-2.5,-.8) rectangle +(11,3);
