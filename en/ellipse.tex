...
\begin{center}
\begin{tikzpicture}
\clip[draw] (-3.5,-2.5) rectangle +(7,5);
...
\end{tikzpicture}
\caption{The foci in the lengths $a$, $c$ in the definition of an ellipse}\label{f.ellipse-features1}
\end{center}
\end{minipage}
\hspace*{2pt}
\begin{minipage}{.48\textwidth}
...
%\begin{center}
%\begin{tikzpicture}
%\clip[draw] (-5,-.5) rectangle +(10,5.5);
%
%\def\a{3.75}
%\def\b{2.5}
...
% Size and center of the ellipse
\clip[draw] (-5,-.7) rectangle +(11.5,4.7);
...
\clip[draw] (-3.5,-2.5) rectangle +(8,5);
...
\begin{center}
\begin{tikzpicture}
\clip[draw] (-3.4,-2.5) rectangle +(6.8,5.4);
% Size and center of the ellipse
\def\a{3}
\def\b{2}
\coordinate (O) at (0,0);
...
\clip[draw] (-3.5,-2.5) rectangle +(7,5.4);
...
%\begin{tikzpicture}
%
%\clip[draw] (-3.8,-2.5) rectangle +(7.5,5.4);
%
%% Size and center of the ellipse
%\def\a{3}
%\def\b{2}
...
\begin{center}
\begin{tikzpicture}
\clip[draw] (-3.1,-3.3) rectangle +(6.2,6.6);
% Size and center of the ellipse
\def\a{3}
\def\b{2}
\coordinate (C) at (0,0);
...
\begin{center}
\begin{tikzpicture}
\clip[draw] (-5,-3.3) rectangle +(10,6.6);
