...
Table~\ref{t.radii-distances} summarizes these data together with the modern values \cite[Table~1.3]{hahn-cic}. While the computed values for the radii of the Earth and the Moon are not far off from the modern values, the other computed values are not near the modern values. Nevertheless, they do show that the Greeks understood the immense size of the solar system.
\begin{table}[h]
\begin{center}
