...
Part~III consists of bonus chapters that present little-known interesting aspects of ellipses. Chapter~\ref{s.constructing} shows how to generate ellipses using roulettes, glissettes and the perfect compass. Chapter~\ref{s.marden} proves the very surprising theorem by Morris Marden.
