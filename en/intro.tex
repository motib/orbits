...
BUT, although Newton invented the calculus and used it to study motion, from the time of the Greeks, \emph{proof} meant proof by geometry. Newton's proof requires a depth of knowledge of Euclidean geometry and conic sections that is no longer studied today to the extent that even Nobel laureate Richard Feynman declined to make the effort to learn the required material. (Instead, he developed his own proof!)

Part~II brings all the required definitions and theorems (and their proofs) required to understand Newton's proof. These theorems are used in Part~I but you can take them on trust. Should you wish to learn more about ellipses than you ever wanted to know, you are invited to study this material.
...
\begin{center}
\begin{tikzpicture}
\clip[draw] (-6,-2.5) rectangle +(10,5);
