...
\begin{center}
\begin{tikzpicture}
\clip[draw] (-4.1,-4.3) rectangle +(8.7,8.4);
\def\rone{2}
\def\re{3}
\def\rtwo{4}
\coordinate (S) at (0,0);
...
\clip[draw] (-.5,-.5) rectangle +(7.1,5.2);
...
\begin{center}
\begin{tikzpicture}[scale=.9]
\clip[draw] (-5.5,-.5) rectangle +(6,5.2);
\def\r{4}
\coordinate (S) at (0,0);
\node[below] at (S) {$S$};
\coordinate (A) at (0,{\r});
