...
We assume that the Earth is in a circular orbit of radius $r_E$ and period $T_E$ around the Sun and that the masses of the two satisfy $m_E \ll m_S$. Let us suppose that we wish to place a space telescope of mass $m_T \ll m_E$ in a circular orbit at $L_1$ which is at distance $r_1\ll r_E$ from the Earth, such that its orbital period $T_1=T_E$ (Figure~\ref{f.lagrange1}). Is this possible?
...
If we ignore the gravitational force exerted by $E$ on the telescope at $L1$, by Kepler's third law
\[
...
Since the length of the orbit at $L1$ is $2\pi r'$, the telescope's velocity is
\begin{equation}
...
x&\approx& \frac{v_1^2}{2r'}(\Delta t)^2\,,
\end{eqn}%
...
\begin{eqnlabels}
\frac{4\pi^2 r_E^3 m_E}{T_E^2}\frac{1}{r_E^2}&=&\frac{Gm_Em_S}{r_E^2}\nonumber\\
\frac{Gm_S}{r'^3}-\frac{Gm_E}{r'r_1^2}&=&\frac{Gm_S}{r_E^3}\nonumber\\
...
\begin{eqn}
F &=& \frac{Gm_Sm_1}{r'^2}+\frac{Gm_Em_1}{r_2^2}\\
